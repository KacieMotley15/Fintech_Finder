...
def send_transaction(w3, account, to, wage):
 ...
 # Construct raw transaction
    raw_tx = {
        ...
        "value": value,
        "gas": gasEstimate,
        "gasPrice": 154210100,  # Set your desired gas price here
...
# Usage example:
# Assuming 'w3', 'account', and 'candidate_address' variables are defined
# 'wage' is the amount of Ether you want to send to the candidate
